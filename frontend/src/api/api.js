...
export const ENDPOINTS = {
  ...
  adminNotificationsExport: `/admin/notifications/export`,

  // Admin Payments
  adminPayments: `/admin/payments`,
  adminPaymentsExport: `/admin/payments/export`,

  // Admin Token Packs
  adminTokenPacks: `/admin/token-packs`,
  adminTokenPacksExport: `/admin/token-packs/export`,

  // Admin Community
  adminCommunityExport: `/admin/community/export`,

  // Admin Support
  adminSupportExport: `/admin/support/export`,
