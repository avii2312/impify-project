...
const PlansPage = () => {
  ...
  async function fetchTokenPacks() {
    try {
      const res = await axiosInstance.get("/token-packs");
      setTokenPacks(res.data.token_packs || []);
    } catch (err) {
      console.error(err);
      // fallback to hardcoded if needed
      setTokenPacks([
        { id: 1, name: "100 Tokens", tokens: 100, price_in_inr: 19 },
        { id: 2, name: "300 Tokens", tokens: 300, price_in_inr: 39 },
        { id: 3, name: "1000 Tokens", tokens: 1000, price_in_inr: 99 }
      ]);
    }
  }
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8">
              {tokenPacks.map((pack, index) => (
                ...
                >
                  ...
                  <div className="text-3xl font-bold mb-4">₹{pack.price_in_inr}</div>
